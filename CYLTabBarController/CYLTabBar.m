...
- (void)layoutSubviews {
    ...
    self.plusButton.center = CGPointMake(taBarWidth * 0.5, taBarHeight * multiplierOfTabBarHeight + constantOfPlusButtonCenterYOffset + 10);
...
/**
 *  Adding pop animation - rotate
 */
- (void)addRotateAnimation:(UIView *)view {
...
- (void)addRotateAnimationOnPlusButton {
    NSLog(@"plusButton.frame = %@", NSStringFromCGRect(_plusButton.frame));
